...
:root {
  ...
  --opacity-image: 1;
  --colors-blue-1: #e6f4ff;
  --colors-blue-2: #bae0ff;
  --colors-blue-3: #91caff;
  --colors-blue-4: #69b1ff;
  --colors-blue-5: #4096ff;
  --colors-blue-6: #1677ff;
  --colors-blue-7: #0958d9;
  --colors-blue-8: #003eb3;
  --colors-blue-9: #002c8c;
  --colors-blue-10: #001d66;
  --colors-purple-1: #f9f0ff;
  --colors-purple-2: #efdbff;
  --colors-purple-3: #d3adf7;
  --colors-purple-4: #b37feb;
  --colors-purple-5: #9254de;
  --colors-purple-6: #722ed1;
  --colors-purple-7: #531dab;
  --colors-purple-8: #391085;
  --colors-purple-9: #22075e;
  --colors-purple-10: #120338;
  --colors-cyan-1: #e6fffb;
  --colors-cyan-2: #b5f5ec;
  --colors-cyan-3: #87e8de;
  --colors-cyan-4: #5cdbd3;
  --colors-cyan-5: #36cfc9;
  --colors-cyan-6: #13c2c2;
  --colors-cyan-7: #08979c;
  --colors-cyan-8: #006d75;
  --colors-cyan-9: #00474f;
  --colors-cyan-10: #002329;
  --colors-green-1: #f6ffed;
  --colors-green-2: #d9f7be;
  --colors-green-3: #b7eb8f;
  --colors-green-4: #95de64;
  --colors-green-5: #73d13d;
  --colors-green-6: #52c41a;
  --colors-green-7: #389e0d;
  --colors-green-8: #237804;
  --colors-green-9: #135200;
  --colors-green-10: #092b00;
  --colors-magenta-1: #fff0f6;
  --colors-magenta-2: #ffd6e7;
  --colors-magenta-3: #ffadd2;
  --colors-magenta-4: #ff85c0;
  --colors-magenta-5: #f759ab;
  --colors-magenta-6: #eb2f96;
  --colors-magenta-7: #c41d7f;
  --colors-magenta-8: #9e1068;
  --colors-magenta-9: #780650;
  --colors-magenta-10: #520339;
  --colors-pink-1: #fff0f6;
  --colors-pink-2: #ffd6e7;
  --colors-pink-3: #ffadd2;
  --colors-pink-4: #ff85c0;
  --colors-pink-5: #f759ab;
  --colors-pink-6: #eb2f96;
  --colors-pink-7: #c41d7f;
  --colors-pink-8: #9e1068;
  --colors-pink-9: #780650;
  --colors-pink-10: #520339;
  --colors-red-1: #fff1f0;
  --colors-red-2: #ffccc7;
  --colors-red-3: #ffa39e;
  --colors-red-4: #ff7875;
  ...
  --colors-red-8: #a8071a;
  --colors-red-9: #820014;
  --colors-red-10: #5c0011;
  --colors-orange-1: #fff7e6;
  --colors-orange-2: #ffe7ba;
  --colors-orange-3: #ffd591;
  --colors-orange-4: #ffc069;
  --colors-orange-5: #ffa940;
  --colors-orange-6: #fa8c16;
  --colors-orange-7: #d46b08;
  --colors-orange-8: #ad4e00;
  --colors-orange-9: #873800;
  --colors-orange-10: #612500;
  --colors-yellow-1: #feffe6;
  --colors-yellow-2: #ffffb8;
  --colors-yellow-3: #fffb8f;
  --colors-yellow-4: #fff566;
  --colors-yellow-5: #ffec3d;
  --colors-yellow-6: #fadb14;
  --colors-yellow-7: #d4b106;
  --colors-yellow-8: #ad8b00;
  --colors-yellow-9: #876800;
  --colors-yellow-10: #614700;
  --colors-volcano-1: #fff2e8;
  --colors-volcano-2: #ffd8bf;
  --colors-volcano-3: #ffbb96;
  --colors-volcano-4: #ff9c6e;
  --colors-volcano-5: #ff7a45;
  --colors-volcano-6: #fa541c;
  --colors-volcano-7: #d4380d;
  --colors-volcano-8: #ad2102;
  --colors-volcano-9: #871400;
  --colors-volcano-10: #610b00;
  --colors-geekblue-1: #f0f5ff;
  --colors-geekblue-2: #d6e4ff;
  --colors-geekblue-3: #adc6ff;
  --colors-geekblue-4: #85a5ff;
  --colors-geekblue-5: #597ef7;
  --colors-geekblue-6: #2f54eb;
  --colors-geekblue-7: #1d39c4;
  --colors-geekblue-8: #10239e;
  --colors-geekblue-9: #061178;
  --colors-geekblue-10: #030852;
  --colors-gold-1: #fffbe6;
  --colors-gold-2: #fff1b8;
  --colors-gold-3: #ffe58f;
  --colors-gold-4: #ffd666;
  --colors-gold-5: #ffc53d;
  --colors-gold-6: #faad14;
  --colors-gold-7: #d48806;
  --colors-gold-8: #ad6800;
  --colors-gold-9: #874d00;
  --colors-gold-10: #613400;
  --colors-lime-1: #fcffe6;
  --colors-lime-2: #f4ffb8;
  --colors-lime-3: #eaff8f;
  --colors-lime-4: #d3f261;
  --colors-lime-5: #bae637;
  --colors-lime-6: #a0d911;
  --colors-lime-7: #7cb305;
  --colors-lime-8: #5b8c00;
  --colors-lime-9: #3f6600;
  --colors-lime-10: #254000;
